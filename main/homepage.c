...
"<p>Start Red Value: <select id=\"sleep_fade_start_r\"></select></p>\n"
"<p>Start Green Value: <select id=\"sleep_fade_start_g\"></select></p>\n"
"<p>Start Blue Value: <select id=\"sleep_fade_start_b\"></select></p>\n"
